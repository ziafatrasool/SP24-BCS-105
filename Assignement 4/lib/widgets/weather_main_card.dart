  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: _getGradient(data.icon),
        boxShadow: [
          BoxShadow(
            color: _getGradient(data.icon).colors.first.withOpacity(0.4),
            blurRadius: 20,
            spreadRadius: 0,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${data.country} • ${DateFormat('EEE, MMM d').format(DateTime.now())}',
                      style: TextStyle(
            ...
            Text(
              'Feels like ${data.feelsLike.round()}° • H:${data.tempMax.round()}° L:${data.tempMin.round()}°',
              style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildStat(Icons.water_drop_outlined, '${data.humidity}%', 'Humidity'),
                  _buildDivider(),
                  _buildStat(Icons.air, '${data.windSpeed.round()} m/s', 'Wind'),
                  _buildDivider(),
                  _buildStat(Icons.compress, '${data.pressure} hPa', 'Pressure'),
                  _buildDivider(),
                  _buildStat(Icons.visibility_outlined, '${(data.visibility / 1000).round()} km', 'Visibility'),
                ],
              ),
            ),
          ],
